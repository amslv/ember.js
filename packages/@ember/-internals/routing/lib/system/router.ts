...
import Router, { Transition } from 'router_js';
import HandlerInfo, { IHandler } from 'router_js/dist/cjs/handler-info';
...
function didBeginTransition(transition: Transition, router: EmberRouter) {
  ...
  transition.promise = transition.catch((error: Error) => {
